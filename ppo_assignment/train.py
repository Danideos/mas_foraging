...
def transition_to_plain(t):
    return {
        ...
        "done": bool(t.done),
        "mode": t.mode,
        "active_plan_before": copy.deepcopy(t.active_plan_before),
        "active_plan_after": copy.deepcopy(t.active_plan_after),
...
def transition_from_plain(d):
    return MacroTransition(
        ...
        active_plan_before=d.get("active_plan_before"),
        active_plan_after=d.get("active_plan_after"),
